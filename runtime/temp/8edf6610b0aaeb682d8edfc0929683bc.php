<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"F:\wamp\www\wanmeinh\public/../app/admin\view\product\index.html";i:1518085559;s:64:"F:\wamp\www\wanmeinh\public/../app/admin\view\common\common.html";i:1517362609;s:61:"F:\wamp\www\wanmeinh\public/../app/admin\view\common\nav.html";i:1512360455;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="x-body">
        <div class="layui-row">
            <form method="get" action="<?php echo url('Product/index'); ?>" class="layui-form layui-col-md12 x-so">
                <div class="layui-input-inline">
                    <input type="text" name="key" value="<?php echo $sreach['key']; ?>" placeholder="请输入产品名称" autocomplete="off" class="layui-input">
                </div>
        ...
        <xblock>
            ...
            <button class="layui-btn" onclick="x_admin_show('添加产品','<?php echo url('Product/create'); ?>')"><i class="layui-icon"></i>添加</button>
        ...
        <table class="layui-table">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td class="td-manage" >
                        <a title="编辑"  onclick="x_admin_show('编辑产品','<?php echo url('Product/edit',['id'=>$vo['id']]); ?>')" href="javascript:;">
                            编辑
                        </a>
