<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"F:\wamp\www\wanmeinh\public/../app/admin\view\test\edit.html";i:1517555519;}*/ ?>
<html>
<head>
    <meta charset="utf-8">
    <title>后台</title>
...
<div class="admin-main layui-anim layui-anim-upbit" ng-app="hd" ng-controller="ctrl">
    <div class="layui-form-item" style="margin-left: 50px;margin-top: 50px">
        ...
        <div class="layui-input-block">
            <input type="text" id="title" name="title" value="<?php echo $info['title']; ?>" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input" style="width: 650px;">
        </div>
    </div>
        ...
        <div id="content" class="yd_box" style="margin-left: 110px;margin-top: 20px;width: 700px">
            ...
            <div class="movie_box" style="border: 1px solid rgb(255, 255, 255);">
                <ul class="wjdc_list">
                    ...
                    <li class="input">
                        <input type="hidden" name="upload_name" value="<?php echo $vv['val']; ?>" class="upload_names">
                        <label>
                            <?php if($vo['type'] == 1): ?>
                            ...
                            <?php endif; ?>
                            <span><?php $p=strrchr($vv['val'],'.'); if($p == '.png' || $p == '.jpg' || $p == '.jpeg' || $p == '.gif'): ?><img src="__PUBLIC__<?php echo $vv['val']; ?>" ><?php else: ?><?php echo $vv['val']; endif; ?></span>
                        </label>
                    </li>
...
<script type="text/javascript">
    ...
    function smit(){
        ...
        $.ajax({
            ...
            type:'post',
            data:{"title":titles,"content":content,"number":number,"type_id":type_id,"id":id},
