<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"F:\wamp\www\wanmeinh\public/../app/admin\view\index\login.html";i:1517362581;s:64:"F:\wamp\www\wanmeinh\public/../app/admin\view\common\common.html";i:1517362609;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="login">
        <div class="message" style="background: #812D43">欢迎登录后台管理系统</div>
        ...
        <form method="post" class="layui-form" >
            ...
            <hr class="hr15">
            <input value="登录" lay-submit lay-filter="login" style="width:100%;background: #812D43" type="submit">
            <hr class="hr20" >
        </form>
    </div>
    <script>
