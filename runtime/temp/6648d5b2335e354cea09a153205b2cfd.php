<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"F:\wamp\www\wanmeinh\public/../app/admin\view\test\index.html";i:1517555103;s:64:"F:\wamp\www\wanmeinh\public/../app/admin\view\common\common.html";i:1517362609;s:61:"F:\wamp\www\wanmeinh\public/../app/admin\view\common\nav.html";i:1512360455;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="x-body">
        <xblock>
            ...
            <button class="layui-btn" onclick="x_admin_show('添加试题','<?php echo url('test/create'); ?>')"><i class="layui-icon"></i>添加</button>
        ...
        <table class="layui-table">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td class="td-manage" >
                        <a title="编辑"  onclick="x_admin_show('编辑试题','<?php echo url('test/edit',['id'=>$vo['id']]); ?>')" href="javascript:;">
                            编辑
                        </a>
    ...
    <script type="text/javascript">
        ...
        function delAll(argument) {
            ...
            layer.confirm('确认删除这条数据？',function(index){
                //捉到所有被选中的，发异步进行删除
                //捉到所有被选中的，发异步进行删除
                var url="<?php echo url('test/delete'); ?>";
