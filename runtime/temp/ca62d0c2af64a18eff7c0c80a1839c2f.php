<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"F:\wamp\www\wanmeinh\public/../app/admin\view\user\index.html";i:1518082654;s:64:"F:\wamp\www\wanmeinh\public/../app/admin\view\common\common.html";i:1517362609;s:61:"F:\wamp\www\wanmeinh\public/../app/admin\view\common\nav.html";i:1512360455;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="x-body">
        <div class="layui-row">
            <form method="get" action="<?php echo url('User/index'); ?>" class="layui-form layui-col-md12 x-so">
                <div class="layui-input-inline">
                    <input type="text" name="key" value="<?php echo $sreach['key']; ?>" placeholder="请输入微信昵称" autocomplete="off" class="layui-input">
                </div>
    ...
    <script type="text/javascript">
        ...
        function get_csv(){
            window.location.href="<?php echo url('User/e_csv'); ?>";
        }
