<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"F:\wamp\www\wanmeinh\public/../app/admin\view\product\create.html";i:1517559008;s:64:"F:\wamp\www\wanmeinh\public/../app/admin\view\common\common.html";i:1517362609;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="x-body">
        <form action="" method="post" class="layui-form layui-form-pane">
            ...
            <div class="layui-form-item">
                <label for="name" class="layui-form-label">
                    <span class="x-red">*</span>需要年货数
                </label>
                <div class="layui-input-inline">
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="integral"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
